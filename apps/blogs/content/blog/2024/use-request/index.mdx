...
import NormalWithoutAnyLibsCode from "./demo/index.jsx?raw";
import NormalWithoutAnyLibsOptimize from "./demo/optimize.jsx";
import NormalWithoutAnyLibsOptimizeCode from "./demo/optimize.jsx?raw";
import NormalWithoutAnyLibsOptimizeFetch from "./demo/optimize-fetch.jsx";
import NormalWithoutAnyLibsOptimizeFetchCode from "./demo/optimize-fetch.jsx?raw";
import NormalWithoutAnyLibsOptimizeHook from "./demo/optimize-hook.jsx";
import NormalWithoutAnyLibsOptimizeHookCode from "./demo/optimize-hook.jsx?raw";
import UseRequestCode from "./demo/useRequest.js?raw";
import NormalWithoutAnyLibsOptimizeHookFinal from "./demo/optimize-hook-final.jsx";
import NormalWithoutAnyLibsOptimizeHookFinalCode from "./demo/optimize-hook-final.jsx";
import UseRequestFinalCode from "./demo/useRequestFinal.js?raw";

## 起因

在自身使用 `React` 实现业务逻辑的时候，经常会遇到组件内部请求数据的场景，如果不依赖第三方我们一般会使用如下代码:

<Code code={NormalWithoutAnyLibsCode} lang="jsx" />

### 结果展示

<NormalWithoutAnyLibs />
...
<Code code={NormalWithoutAnyLibsOptimizeCode} lang="jsx" />

### 结果展示

<NormalWithoutAnyLibsOptimize />

以上代码当当组件销毁后，不会再执行回掉中的操作，避免了内存溢出的风险。让我门再进一步，将接口请求也取消试试，代码如下：

<Code code={NormalWithoutAnyLibsOptimizeFetchCode} lang="jsx" />

### 结果展示

<NormalWithoutAnyLibsOptimizeFetch />
...
<Code code={NormalWithoutAnyLibsOptimizeHookCode} lang="jsx" />
<Code code={UseRequestCode} lang="js" />

### 结果展示

<NormalWithoutAnyLibsOptimizeHook />
...
<Code code={NormalWithoutAnyLibsOptimizeHookFinalCode} lang="jsx" />
<Code code={UseRequestFinalCode} lang="js" />

### 结果展示

<NormalWithoutAnyLibsOptimizeHookFinal />
